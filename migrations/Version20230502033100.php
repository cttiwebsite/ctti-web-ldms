...
final class Version20230502033100 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE about (id INT SERIAL NOT NULL, email_address VARCHAR(255) NOT NULL, phone_number VARCHAR(255) NOT NULL, fax_number VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, mission_statement VARCHAR(255) NOT NULL, vision VARCHAR(255) NOT NULL, motto VARCHAR(255) NOT NULL, history LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event (id INT SERIAL  NOT NULL, event_name VARCHAR(255) NOT NULL, event_start DATE NOT NULL, event_end DATE NOT NULL, event_location VARCHAR(255) NOT NULL, event_host VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE news (id INT SERIAL  NOT NULL, heading VARCHAR(255) NOT NULL, content VARCHAR(255) NOT NULL, date VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE program (id INT SERIAL  NOT NULL, section_id INT DEFAULT NULL, program_code VARCHAR(255) NOT NULL, program_name VARCHAR(255) NOT NULL, program_duration VARCHAR(255) NOT NULL, program_certification VARCHAR(255) NOT NULL, program_type VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, INDEX IDX_92ED7784D823E37A (section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
